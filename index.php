...
<!--00A098-->
    ...
    <body>
                ...
                <div class="row g-5">
                    <div class="col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="bg-light rounded">
                            ...
                            <img src="img/Passport.jpg" class="img-fluid w-100 border-bottom border-5 border-primary" style="border-top-right-radius: 300px; border-top-left-radius: 300px;" alt="Image">
                        </div>
                    </div>
                            ...
                            <div class="col-8 col-md-9">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <span class="text-secondary fw-bold fs-5" style="letter-spacing: 2px;">Free:+977 9849875057</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Counter Facts Start -->
        <div class="container-fluid counter-facts py-5" id="service">
            <div class="container py-5">
                <div class="row g-4">
 ...
 <div class="container-fluid country overflow-hidden py-5">
    <div class="container">
        ...
        <!-- Countries Grid -->
        <div class="row g-4 text-center" id="country-grid">
            <!-- Page 1 -->
            <div class="col-lg-4 mb-5 mb-lg-0 country-item-page" data-page="1">
                <div class="country-item">
                    ...
                    <div class="country-flag">
                        <img src="img/uae.png" class="img-fluid rounded-circle" alt="Image">
                    </div>
            ...
            <div class="col-lg-4 mb-5 mb-lg-0 country-item-page" data-page="1">
                <div class="country-item">
                    ...
                    <div class="country-flag">
                        <img src="img/qatar.png" class="img-fluid" alt="Image">
                    </div>
                    <div class="country-name">
            ...
            <div class="col-lg-4 mb-5 mb-lg-0 country-item-page" data-page="1">
                <div class="country-item">
                    ...
                    <div class="country-flag">
                        <img src="img/saudhi.png" class="img-fluid" alt="Image">
                    </div>
                    <div class="country-name">
                        <a href="#" class="text-white fs-4">Saudi Arabia</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 mb-5 mb-lg-0 country-item-page" data-page="2" style="display:none;">
                <div class="country-item">
                    ...
                    <div class="country-flag">
                        <img src="img/baharain.png" class="img-fluid" alt="Image">
                    </div>
                    <div class="country-name">
           ...
           <div class="col-lg-4 mb-5 mb-lg-0 country-item-page" data-page="2" style="display:none;">
                <div class="country-item">
                    <div class="rounded overflow-hidden">
                        <img src="img/country-1.jpg" class="img-fluid w-100 h-100 rounded" alt="Image">
                    </div>
                    <div class="country-flag">
                        <img src="img/oman.png" class="img-fluid" alt="Image">
                    </div>
                    <div class="country-name">
                        <a href="#" class="text-white fs-4">Oman</a>
                    </div>
                </div>
            </div>
...
<nav aria-label="Country pagination">
    <ul class="pagination justify-content-center mt-5">
        <li class="page-item"><a class="page-link" href="#" onclick="showPage(1); return false;">1</a></li>
        <li class="page-item"><a class="page-link" href="#" onclick="showPage(2); return false;">2</a></li>
    </ul>
</nav>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ps-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <a href="#" class="fs-5 text-primary">+977 9849875057</a>
                                        </div>
                                        <div class="mb-3">
                                            <h6 class="mb-0">Email:</h6>
                                            <a href="#" class="fs-5 text-primary"> inquiry@skillednepali.com </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
 ...
 <div class="container-fluid footer py-5 wow fadeIn" data-wow-delay="0.2s">
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href=""><i class="fa fa-map-marker-alt me-2"></i> Sinamangal - 9, Kathmandu Nepal</a>
                    <a href=""><i class="fas fa-envelope me-2"></i> inquiry@skillednepali.com</a>
                    <a href=""><i class="fas fa-phone me-2"></i> 9849875057</a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <h4 class="text-light mb-4">Opening Time</h4>
                    <div class="mb-3">
                        <h6 class="text-light mb-0">Mon - Friday:</h6>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Business Solutions</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Skill Evaluation</a>
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Migration & Visa Support</a>
                    ...
                    <a href="#"><i class="fas fa-angle-right me-2"></i> Work & Recruitment</a>
                </div>
            </div>
            <!-- Newsletter -->
            <div class="col-md-6 col-lg-6 col-xl-3">
        ...
        <div class="row g-4 align-items-center pt-4 mt-4 border-top">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-white">
                    <a href="#" class="border-bottom text-white">
                        <i class="fas fa-copyright text-light me-2"></i>Skilled Nepali
...
function showPage(page) {
    const items = document.querySelectorAll('.country-item-page');
    items.forEach(item => {
